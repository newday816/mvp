...
var rule = {
    ...
    lazy: $js.toString(() => {
        try {
            let api="http://101.201.171.207:9898/home/api?type=ys&uid=51497&key=ceinpqtvAJKLWX1236&url=" + input.split("?")[0];
            console.log(api);
    ...
    二级: $js.toString(() => {
        ...
        VOD.vod_play_from = yg.length < 1 ? "Brilliant4k" : "❤️Brilliant4k$$$Brilliant4k";
